...
final class StaticTable {
    ...
    /* 62 */ new HeaderField(EMPTY, EMPTY),
    /* 63 */ new HeaderField(EMPTY, EMPTY),
    /* 64 */ new HeaderField(EMPTY, EMPTY),
    /* 65 */ new HeaderField(EMPTY, EMPTY),
    /* 66 */ new HeaderField(EMPTY, EMPTY),
    /* 67 */ new HeaderField(EMPTY, EMPTY),
    /* 68 */ new HeaderField(EMPTY, EMPTY),
    ...
    /* 76 */ new HeaderField(EMPTY, EMPTY),
    /* 77 */ new HeaderField(EMPTY, EMPTY),
    /* 78 */ new HeaderField(EMPTY, EMPTY),
    /* 79 */ new HeaderField(EMPTY, EMPTY),
